...
module  vga_controller1152 ( input        Clk,       // 50 MHz clock
                                      Reset,     // reset signal
    ...
    parameter [10:0] hpixels = 10'd1519;
    parameter [10:0] vlines = 10'd894;
   ...
   always_ff @ (posedge Clk or posedge Reset )
    ...
    begin : hsync_proc
        if ( Reset ) 
            ...
            if (((hc + 1) >= 10'd1216) & ((hc + 1) < 10'd1336)) 
                hs <= 1'b0;
            else 
				    hs <= 1'b1;
    end
    ...
    begin : vsync_proc
        if ( Reset ) 
           vs <= 1'b0;
            ...
            if (((vc + 1) == 10'd865) | (((vc + 1) == 10'd866) | ((vc + 1) == 10'd867)))
			       vs <= 1'b0;
            else 
			       vs <= 1'b1;
    end
