...
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../toplevel_soc.sopcinfo
...
# Design Name 
# setting SOPC_NAME is toplevel_soc
SOPC_NAME := toplevel_soc
...
# setting SOPC_SYSID_BASE_ADDRESS is 0xaa0
SOPC_SYSID_FLAG += --sidp=0xaa0
ELF_PATCH_FLAG  += --sidp 0xaa0

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1682997777
SOPC_SYSID_FLAG += --timestamp=1682997777
ELF_PATCH_FLAG  += --timestamp 1682997777
